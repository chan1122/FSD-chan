// 카테고리 JQUERY VOGUE PAGE JS - categori.js
...
/**********************************************  
   ...
   1 . 제이슨 가져오기 메서드 : $.getJSON(파일경로,함수)
...
$(() => {
  ...
  // 경로에 있는 제이슨파일을 가져와서 변환후 변수에 답는다
...
function loadFn(cdata) { // cdata - 제이슨 전달값
    ...
    // 대상 .cont
    // 넣을 데이터 : 객체중(제이슨 데이터) : "경로"
    $(".cont").addClass(data["경로"]);

    // (3) LNB메뉴 셋팅하기
    // 넣을 데이터 : 객체중 "메뉴"
    // 메뉴 데이터기 "없음"이 아닐경우 셋팅함
    let menu = data["메뉴"];
    console.log("메뉴",menu)
