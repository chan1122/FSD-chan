...
const {
    default: $,
} = require("../../../../05.jQuery학습/004.플러그인/009.swiper-4.1.0/swiper-4.1.0/src/utils/dom");
...
$(() => {
 ...
 input[type=password]`).blur(function () {
    ...
    *********************************************/
    ...
    /******************************************************** 
      ...
      검사중간에 불통가 사유 발생시 false로 변경!
      유효성 검사 통과여부를 판단한다!

      검사방법:
      기존 이벤트 blur 이벤트를 강제로 발생시킨다!

      이벤트 강제 발생은 메서드는? -> trigger(이벤트이다)
  ********************************************************/
    ...
    // 이벤트 대상: 서브밋 버튼 -> #btnj
    // 원레 가입하기 버튼은 클릭시 싸고 있는 form태그의
    // action속성에 지정되어 있는 페이지로 현제 페이지의
 ...
 input[type=password]`).trigger("blur");
    ...
    ********************************************/
            ...
            alert("Vogue에 오신것을 환영합니다!");
            // 원레는 post 방식으로 DB에 회원정로를 입력후
            // DB에 입력완료시 위의 메시지를 띄워준다!
        } //// 통과시 if문
        else {
            //불통시 !
            alert("옳지않은 방식입니다. 입력방식을 확인하여주세요");
        }
    });
}); ///////////// jQB //////////////////
