...
// return (jsx문법적용 태그-> 따옴표 없이 바로사용)
// 홀로태그는 꼭 닫기문법 적용(xml문법) -> 예) <br  />
// 함수명은 첫글자가 반드시!!! 반드시!!! 반드시!!! 대문자로 시작!
// 아니면 아나옴! (원레는 클래스 기반에서 구현된것이므로 클래스가
// 원레 처글자가 대문자로 시작된다!!!)
  ...
  return (
    <div>
      ...
      <h2>
        [ 리액트란? ] <br />
        <br />
        # 프론트엔드 JS 라이브러리다! # 사용자 UI의 구성요소를 빌드하기 위한도구다
        <br />
        [ 작동원리 ] <br />
        <br />
...
// 리액트로 html요소 페이지 요소에 삽입한다!
// 가상돔을 셋팅하는 리액트 객체를 부른다. -> ReactDOM
// render() -> 요소를 변경하는 메서드
// 요소를 리턴하는 함수명으로된 홀로태그를씀,넣을요소 -> myFirstReact함수이므로
// ->>> <myFirstReact />
// JSX문법이므로 따옴표로 안싼다!!!
